...
<div class="absolute top-2/4 left-2/4 text-center {margin}" in:fade="{{ duration: 100 }}">
    {#if on == "loading"}
    <svg class="animate-spin -mt-5 -ml-5 sm:-mt-6 sm:-ml-6 h-10 w-10 sm:w-12 sm:h-12 text-gray-300 dark:text-dpink" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
